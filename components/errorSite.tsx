        ...
        >
            <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    <Link
                        href={"/"}
                        className="rounded-md bg-primary-button px-3.5 py-2.5 text-sm font-semibold text-text shadow-sm shadow-primary-button hover:shadow-primary-button hover:shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:primary-button"
                    >
                        Go back to home
                    </Link>
                    <Link
