    ...
    <>
      ...
      <section className="p-8">
        <div className="relative mt-4 min-h-[80vh]">
          <div className="absolute z-10 top-[8%] mt-4 flex w-full flex-col items-center justify-center md:mt-0 lg:left-1/2 lg:-translate-x-1/2">
          ...
          <Link
            passHref
            href="/cars"
            className="absolute z-10 bottom-5 ml-4 md:bottom-[8%] lg:left-1/2 lg:-translate-x-1/2"
          >
            <button
              type="button"
              className="flex items-center justify-center rounded-md bg-background dark:bg-darkbg py-2 pl-6 text-center text-sm font-semibold text-text dark:text-darktext shadow-sm hover:shadow-xl focus:outline-none focus:ring-4"
            >
              Car catalog
              <IconArrowUpRight
                className="mx-2 mr-4"
          ...
          <SubmitForm className="absolute z-10 bottom-[8%] right-[5%] hidden flex-col space-y-4 rounded-xl bg-background dark:bg-darkbg p-4 md:flex" />
          <Image
            src={"/hero.jpg"}
        ...
        {/* MOBILE VERSION */}
        <SubmitForm className="mx-4 mt-4 flex flex-col space-y-4 rounded-xl bg-background dark:bg-darkbg p-4 md:hidden border border-text" />
      ...
      <section className="mb-20 mt-20">
        <div className="grid gap-5 px-8 md:grid-cols-2 md:gap-10 md:px-36 lg:grid-rows-2 xl:grid-cols-3">
          <div className="flex flex-col items-center leading-6 md:block">
            <h2 className="py-12 text-4xl font-bold md:text-3xl lg:text-5xl 2xl:text-6xl text-text dark:text-darktext">
              Our Services
            </h2>
          ...
          <div className="relative flex min-h-[280px] items-end justify-center md:row-span-2">
            <Image
              ...
              className="h-auto max-h-[280px] transform rounded-xl object-cover object-center shadow-xl transition duration-500 ease-in-out hover:-translate-y-1 hover:scale-105 hover:shadow-2xl
                            md:max-h-[600px]"
            />
            <button className="absolute bottom-[2%] left-[3%] rounded-md bg-background dark:bg-darkbg text-text dark:text-darktext px-6 py-1.5 shadow-sm">
              Wedding events
            </button>
          </div>
          <div className="relative flex min-h-[280px] items-end">
            ...
            />
            <button className="absolute bottom-[5%] left-[3%] rounded-md bg-background dark:bg-darkbg text-text dark:text-darktext px-6 py-1.5 shadow-sm">
              Intercity trips
            </button>
          </div>
          <div className="relative flex min-h-[280px] items-end">
        ...
        <div className="mt-4 p-2 md:p-8 ">
          <div className="flex flex-col md:p-10">
            <div className="mx-6 flex flex-col items-center justify-center gap-10 md:mx-0 md:flex-row">
              <h1 className="text-5xl font-bold leading-6 md:py-12 md:text-4xl xl:text-7xl text-text dark:text-darktext">
                Our Fleet
              </h1>
            ...
            <div className="flex flex-col">
              ...
              <span className="flex justify-center pt-4">
                <Link passHref href={"/cars"}>
                  <button className="flex transform items-center rounded-md bg-primary-button py-1.5 pl-6 text-background dark:text-darkbg shadow-sm md:shadow-md shadow-primary-button duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg hover:shadow-primary-button">
      ...
      <section className="mb-40 mt-20">
        <div className="md:p8 mt-4 p-2">
          <div className="flex flex-col items-center justify-center gap-10 pb-6 pt-12 md:flex-row md:py-12">
            <h1 className="text-4xl font-bold leading-6 md:text-5xl xl:text-7xl text-text dark:text-darktext">
              Why Choose Us
            </h1>
          ...
          <div className="grid gap-10 md:grid-cols-2 md:grid-rows-2 xl:grid-cols-4 xl:grid-rows-1">
            {whyChooseUs.map((el, index) => (
              <div key={index} className="flex flex-col">
                <div className="flex bg-secondary-button aspect-square transform items-center justify-center rounded-xl text-accent dark:text-darkbg shadow-xl transition duration-500 ease-in-out hover:-translate-y-1 hover:scale-105">
                  {el.icon}
                </div>
        ...
        <div className="m-2 max-w-5xl sm:m-4">
          ...
          <div className="grid grid-cols-4 grid-rows-4 rounded-3xl border p-2 shadow-xl sm:p-4">
            <div className="col-span-2 flex items-center justify-center">
              <h1 className="font-semibold leading-6 sm:text-xl md:text-3xl lg:text-5xl text-text dark:text-darktext">
                {hotOffer.brand + " "}
      ...
      {/* footer */}
      <footer>
        <div className="m-2 md:mb-0 grid gap-3 rounded-3xl mb-0 bg-accent p-6 pt-10 md:m-8 md:p-8 lg:grid-cols-5 lg:grid-rows-6 lg:gap-0 ">
          <Link
            passHref
            href="/"
          ...
          >
            <Image
              className="h-auto w-auto bg-transparent rounded-full"
              src={"/logo1.png"}
              alt="logo"
              width={32}
              height={32}
          ...
          <div className="col-span-2 row-span-3 hidden flex-col justify-center space-y-4 p-4 lg:flex">
            ...
            <div className="relative w-3/5">
              ...
              <input
                ...
                name="newsletter"
                id="newsletter"
                className="w-full cursor-default bg-background rounded-md border-none py-1.5 pl-4 pr-10 text-left text-text placeholder:text-text/20 dark:text-darktext shadow-sm ring-1 ring-inset ring-background  dark:ring-transparent dark:placeholder:text-darktext dark:bg-darkbg focus:outline-none focus:ring-2 focus:ring-primary-button-500 sm:text-sm sm:leading-6"
          ...
          <div className="row-span-3 hidden flex-col items-start space-y-2 text-sm lg:flex">
            {cities.map((el, index) => (
              <div key={index} className="text-background dark:text-darkbg">
                <h1>{el}</h1>
              </div>
            ))}
          </div>
          ...
          <div className="flex items-end gap-1 text-background dark:text-darkbg lg:hidden">
            <span className="flex items-center">
              <IconCopyright size={14} aria-label="copyright" />
              <h3 className="text-xs md:text-sm">2023 Car-rental</h3>
            </span>
          </div>
