  ...
  return (
    <main className="mt-4 flex justify-center bg-background dark:bg-darkbg">
      ...
      <div className="grid max-w-7xl gap-6 rounded-xl p-4 md:grid-cols-3">
        <div className="row-span-6 hidden h-screen rounded-xl bg-background dark:bg-darkbg text-text dark:text-darktext shadow-xl md:block">
          TODO
        </div>
        <div className="col-span-2 row-span-1 flex flex-col gap-8 md:flex-row">
          ...
          />
          <div className="mx-auto ml-2 rounded-2xl bg-background dark:bg-darkbg p-2 px-4 shadow-md md:mx-0">
            <h1 className="pb-2 text-3xl font-bold text-text dark:text-darktext">
              Owner Info
            </h1>
            <p className="font-semibold text-gray-500">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Temporibus aut animi veritatis vero in qui.
            </p>
          </div>
        </div>
        ...
        <div className="col-span-2 row-span-1 grid grid-cols-2 grid-rows-2 gap-4 md:grid-cols-4  md:grid-rows-1">
          <div className="flex transform flex-col items-center rounded-xl bg-background dark:bg-darkbg p-2 shadow-lg shadow-amber-700/30 transition duration-500 ease-in-out hover:-translate-y-1 hover:scale-105">
          ...
          <div className="flex transform flex-col items-center rounded-xl bg-background dark:bg-darkbg p-2 shadow-lg shadow-rose-700/30 transition duration-500 ease-in-out hover:-translate-y-1 hover:scale-105">
            <div className="aspect-square rounded-full bg-rose-600/20 p-2 text-rose-700 shadow-sm shadow-rose-700">
              <IconHorseToy aria-label="horse" className="h-10 w-auto" />
            </div>
            <p className="font-bold uppercase text-text dark:text-darktext">
              {car.horsepower}
            </p>
          ...
          <div className="flex transform flex-col items-center rounded-xl bg-background dark:bg-darkbg p-2 shadow-lg shadow-primary-button/30 transition duration-500 ease-in-out hover:-translate-y-1 hover:scale-105">
          ...
          <div className="flex transform flex-col items-center rounded-xl bg-background dark:bg-darkbg p-2 shadow-lg shadow-emerald-700/30 transition duration-500 ease-in-out hover:-translate-y-1 hover:scale-105">
            <div className="aspect-square rounded-full bg-emerald-600/20 p-2 text-emerald-700 shadow-sm shadow-emerald-700">
              <IconManualGearbox aria-label="gearbox" className="h-10 w-auto" />
            </div>
            <p className="font-bold uppercase text-text dark:text-darktext">
              {car.transmission}
            </p>
        ...
        <div className="col-span-2 row-span-1 grid gap-4 md:grid-cols-2">
          <div className="rounded-xl bg-background dark:bg-darkbg p-3 py-1.5 shadow-md">
            <h1 className="border-b pb-3 pt-5 text-2xl font-bold capitalize text-text dark:text-darktext border-text">
              vehicle condition
            </h1>
            <ul className="space-y-2 p-2 pb-5">
              ...
              <li className="flex gap-1">
                <IconGasStation aria-label="fuel" className="text-rose-700" />
                <h1 className="grow font-semibold text-text dark:text-darktext">
                  Average Fuel Consumption
                </h1>
                <h1 className="text-green-400 font-semibold">8 km/l</h1>
              </li>
              <li className="flex gap-1">
                <IconInnerShadowRight
                  aria-label="fuel"
          ...
          <div className="rounded-xl bg-background dark:bg-darkbg p-3 py-1.5 shadow-md">
            ...
            <ul className="space-y-2 p-2 pb-5">
              <li className="flex gap-1">
                <IconHammer aria-label="hammer" className="text-emerald-700" />
                <h1 className="grow font-semibold text-text dark:text-darktext">
                  Lorem ipsum dolor sit amet.
                </h1>
                <h1 className="font-semibold text-gray-400">2 days ago</h1>
              </li>
              <li className="flex gap-1">
                <IconHammer aria-label="hammer" className="text-emerald-700" />
                <h1 className="grow font-semibold text-text dark:text-darktext">
                ...
                <h1 className="font-semibold text-gray-400">1 day ago</h1>
              </li>
              <li className="flex gap-1">
                <IconHammer aria-label="hammer" className="text-emerald-700" />
                <h1 className="grow font-semibold text-text dark:text-darktext">
                ...
                <h1 className="font-semibold text-gray-400">a week ago</h1>
              </li>
            </ul>
          </div>
        </div>
        <div className="col-span-2 row-span-1 rounded-xl bg-background dark:bg-darkbg p-3 py-1.5 shadow-md">
          <h1 className="border-b border-text pb-3 pt-5 text-2xl font-bold capitalize text-text dark:text-darktext">
            Images
          </h1>
          <div className="pt-3">
