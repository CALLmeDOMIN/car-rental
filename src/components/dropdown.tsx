  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="relative mt-1">
        <button
          type="button"
          className="focus:ring-primary-button relative w-full cursor-default rounded-md bg-background dark:bg-darkbg py-1.5 pr-10 text-left text-text dark:text-darktext shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 sm:text-sm sm:leading-6"
              ...
              (location, id) =>
                location.isSelected && (
                  <div key={id} className="flex items-center">
                    <span className="px-2">{location.icon}</span>
        ...
        >
          {locations.map((location, id) => (
            <li
              ...
              aria-selected="true"
              onClick={() => {
                locations.forEach((location) => (location.isSelected = false));
