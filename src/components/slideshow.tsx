        ...
        {photos.map((photo) => (
          ...
          >
            <Link
              ...
              href={`/car/${photo.id}`}
              className={
                "mx-2 flex transform flex-col gap-2 rounded-2xl transition shadow-md duration-500 ease-in-out hover:-translate-y-1 hover:scale-105 " +
            ...
            >
              ...
              {photo.people && (
                <div className="flex justify-start gap-2">
                  <div className="flex items-center gap-1 rounded-md bg-background dark:bg-darkbg p-1 px-1 pr-2">
                    <IconUser
