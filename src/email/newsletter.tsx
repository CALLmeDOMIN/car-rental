      ...
      <Body className="bg-bg font-sans text-text">
        <Container className="mx-auto flex h-screen items-center pb-12 pt-5">
          ...
          <Text className="text-base">
            Welcome to Car-rental! <br /> Its a pleasure to send to you this
            email. <br /> The purpose of this is to learn about newest approach
            to programming emails. Your email will not be shared with anyone or
            stored, its just a one timer.
          </Text>
          ...
          <Text className="text-xs text-secondary-button">Car-rental 2023</Text>
        </Container>
      </Body>
    </Tailwind>
  </Html>
